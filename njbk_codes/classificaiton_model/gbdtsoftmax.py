...
#        y_pred_contrib = gbm.predict(X_test,pred_contrib = True)
...
#    X_train,X_test,y_train,y_test = nj.dataSplit(df,'IS_LOST',0.2)
#    gbm,y_test,y_predict,y_predict_prob= nj.gbdtAlgorithm(X_train,X_test,y_train,y_test)
#    print('----只使用GBDT的模型效果----')
#    nj.evalution(y_test,y_predict)
#    print('----只使用LR的模型效果-------')
#    y_test,y_predict = nj.lrAlgorithm(X_train,X_test,y_train,y_test)
#    nj.evalution(y_test,y_predict)
#    
